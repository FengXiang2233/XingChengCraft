package me.fengxiang2233.XingChengCraft.Machines.BasicMachine;
...
public abstract class BasicMachine extends SlimefunItem implements InventoryBlock, EnergyNetComponent, MachineProcessHolder<CraftingOperation> {
    ...
    protected BasicMachine(ItemGroup itemGroup, String id, ItemStack it, RecipeType recipeType, ItemStack[] recipe) {
    ...
    protected BasicMachine(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    protected BlockBreakHandler onBlockBreak() {
        return new SimpleBlockBreakHandler() {
            public void onBlockBreak(@NotNull Block b) {
                ...
                if (inv != null) {
                    inv.dropItems(b.getLocation(), BasicMachine.this.getInputSlots());
                    inv.dropItems(b.getLocation(), BasicMachine.this.getOutputSlots());
                }

                BasicMachine.this.processor.endOperation(b);
            }
        };
    }
